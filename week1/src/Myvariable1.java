...
public static void main(String[] args){
    String name = "Yan"; // after a statement, don't forget the semi colon!
...
//  building="Empire State", tree = "Maple", lake = "Lake Superior", ocean = "Pacific Ocean";
    ...
    months = 3;
    years = 5;
//    int week = 4, decades = 10, months = 3, years = 5;
